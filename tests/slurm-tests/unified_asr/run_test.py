...
def run_unified_asr_test(
    ...
    input_file = "/nemo_run/code/tests/slurm-tests/unified_asr/asr_openai.test"
    ...
    generate(
        ...
        server_args="--backend nemo_asr --batch_size 2",
...
def main():
    ...
    parser.add_argument("--model", default=DEFAULT_MODEL, help="ASR model path/name")
    ...
    asr_expname = run_unified_asr_test(
